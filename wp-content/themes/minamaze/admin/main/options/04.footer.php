...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 1.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_footerw2() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 2.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw3() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 3.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw4() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 4.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw5() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 5.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw6() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'minamaze') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 6.', 'minamaze') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'minamaze' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'minamaze') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_copyright() {
	...
	printf( esc_html__( 'Theme by %1$s. Powered by %2$s.', 'minamaze' ), '<a href="https://www.thinkupthemes.com/" target="_blank">Think Up Themes Ltd</a>', '<a href="https://www.wordpress.org/" target="_blank">WordPress</a>' ); 
}
