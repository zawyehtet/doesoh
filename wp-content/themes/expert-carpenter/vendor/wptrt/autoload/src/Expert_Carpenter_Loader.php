...
class Expert_Carpenter_Loader {
	 ...
	 * @return void
	 */
	public function expert_carpenter_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function expert_carpenter_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function expert_carpenter_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function expert_carpenter_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->expert_carpenter_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function expert_carpenter_load( $class ) {
